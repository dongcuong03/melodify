...
import 'package:melodify/models/song_model.dart';
...
class _AdminAddSongScreenState extends State<AdminAddSongScreen> {
                            ...
                            onPressed: () async {
                              ...
                              if (_formKey.currentState!.validate()) {
                                if (_audioFile == null ||
                                  ...
                                  String genre = _selectedGenre.toString();
                                  String audioUrl =
                                  ...
                                  if (provider.errorMessage == null) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Thêm bài hát ${title.toLowerCase()} thành công!',
  ...
  Widget _buildFilePicker(String type, String label, String? fileUrl, bool isUploading, bool isSaved) {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            '(Vui lòng chọn file ${label.toLowerCase()} trong máy để lưu trữ tại hệ thống)',
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                else if (fileUrl != null && !isUploading)
                  Positioned.fill(
                    child: Align(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          _getFileIcon(fileUrl), // Hiển thị biểu tượng phù hợp
                          Text(fileUrl.split('/').last), // Tên file
                        ],
                      ),
                    ),
                  )
                // Nếu đang tải, hiển thị CircularProgressIndicator
                    ...
                    Center(
                      child: CircularProgressIndicator(
                        valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF005609)),
                      ),
                    ),
